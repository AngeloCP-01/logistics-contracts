...
npx redocly lint openapi/auth-service.yaml openapi/user-service.yaml openapi/order-service.yaml openapi/dispatch-service.yaml openapi/tracking-service.yaml openapi/notification-service.yaml
